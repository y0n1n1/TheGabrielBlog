...
const Article1 = () => {
  return (
    <div className="items-center justify-center flex flex-row ">
        <div className="w-5/6 sm:w-4/5 md:w-2/3 lg:w-3/5 my-12">
        ...
        <img src="./../../../public/A1-1.png" className="my-5" />
        ...
        <img src="./../../../public/A1-2.png" className="my-5" />
        ...
        <img src="./../../../public/A1-3.png" className="my-5" />

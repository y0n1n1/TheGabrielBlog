...
def ReLU(x):
  ...
  return (
    <div className="items-center justify-center flex flex-row">
        ...
        <img src="./../../../public/A4-1.png" className="my-5 h-72" />
            </div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-2.png" className="my-5 h-72" />
                </div>
...
<div className="w-full items-center align-middle flex flex-col">
<img src="./../../../public/A4-3.png" className="my-5 h-72" />
    </div>
            ...
            <img src="./../../../public/A4-4.png" className="my-5 h-72" />
                </div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-5.png" className="my-5 h-72" />
                </div>
            <div className="font-medium text-3xl my-2 mb-4 text-zinc-950">1. Leaky ReLU (LReLU)</div>
            <div className="w-full items-center align-middle flex flex-col"><img src="./../../../public/A4-6.png" className="my-5 h-72" /></div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-7.png" className="my-5 h-72" />
                </div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-8.png" className="my-5 h-72" />
                </div>
  ...
  The standard deviation is approximately one
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-9.png" className="my-5 h-72" />
                </div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-10.png" className="my-5 h-72" />
                </div>
            ...
            <div className="w-full items-center align-middle flex flex-col">
            <img src="./../../../public/A4-11.png" className="my-5 h-72" />
                </div>
